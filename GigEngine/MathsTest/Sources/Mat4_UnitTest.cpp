...
#define CHECK_MAT4(Mat,GlmMat) CHECK(Mat[0][0] == Catch::Approx(GlmMat[0][0])); CHECK(Mat[0][1] == Catch::Approx(GlmMat[0][1])); CHECK(Mat[0][2] == Catch::Approx(GlmMat[0][2])); CHECK(Mat[0][3] == Catch::Approx(GlmMat[0][3])); CHECK(Mat[1][0] == Catch::Approx(GlmMat[1][0])); CHECK(Mat[1][1] == Catch::Approx(GlmMat[1][1])); CHECK(Mat[1][2] == Catch::Approx(GlmMat[1][2])); CHECK(Mat[1][3] == Catch::Approx(GlmMat[1][3])); CHECK(Mat[2][0] == Catch::Approx(GlmMat[2][0])); CHECK(Mat[2][1] == Catch::Approx(GlmMat[2][1])); CHECK(Mat[2][2] == Catch::Approx(GlmMat[2][2])); CHECK(Mat[2][3] == Catch::Approx(GlmMat[2][3])); CHECK(Mat[3][0] == Catch::Approx(GlmMat[3][0])); CHECK(Mat[3][1] == Catch::Approx(GlmMat[3][1])); CHECK(Mat[3][2] == Catch::Approx(GlmMat[3][2])); CHECK(Mat[3][3] == Catch::Approx(GlmMat[3][3]));
...
TEST_CASE("Mat4", "[.all][matrice][Mat4]")
{
    ...
    SECTION("Functionality")
    {
        ...
        SECTION("Rotation")
        {
            FMat4 rotationMat = FMat4::Rotate(FMat4::Identity(), 5.f, FVec3{ 2.f, 3.f, 4.f });
            glm::mat4 rotationMatGlm = glm::rotate(glm::mat4(1.f), 5.f, glm::vec3(2.f, 3.f, 4.f));
            CHECK_MAT4(rotationMat, rotationMatGlm);
        }
        SECTION("MVP")
        {
